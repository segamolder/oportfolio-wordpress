            ...
            <div class="container">
                <div class="row no-gutters slider-text justify-content-center align-items-center">
                    <div class="col-md-8 ftco-animate">
                        <p class="breadcrumbs"><span class="mr-2"><a href="<? echo get_site_url() ?>">Главная</a></span> <span>Блог</span>
                        </p>
                ...
                <div class="row d-flex">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            $btmetanm = isset($_GET['category']) ? $_GET['category'] : $btmetanm;
                            $post_tag = isset($_GET['tag']) ? $_GET['tag'] : '';
                            $args = array('posts_per_page' => 5, 'category_name' => $btmetanm,
                                'paged' => $paged, 'post_type' => 'post', 'tag'=>$post_tag, 's'=>$search);
